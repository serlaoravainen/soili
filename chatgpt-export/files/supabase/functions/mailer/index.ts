...
const EMPLOYEE_JOB_TYPES: EmployeeJobType[] = [
  "employee_shift_changed",
  "employee_new_shift",
  "employee_shift_deleted",
];
...
async function processEmployeeJobsAggregated(
  anchorJob: BaseJob,
  settings: AppSettingsRow,
): Promise<AggregationResult> {
  if (!settings.email_notifications || !settings.schedule_changes)
    return "skipped: schedule notifications off";
